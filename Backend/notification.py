...
class Notification:
    ...
    def sendToDevice(self, token, title, body):
        token = "cYgzqik3Sdu88GhM6Kz7FO:APA91bFyrSyqmoM0KoTRkZAxaESVfKOPwttewVuIzFsj_5XyZyWmDLT5Uksi-ert1M4IlMZWK4BPHJyy1azbTkkDHLlhpvuzGhDRP8rZqlX9XaKYdXm3JsAS7LDdDM62T-5CymXw_OHf"
        #message_title = "From python"
        #message_body = "Content of message sent from python"
...
if __name__ == "__main__":
    Notification().sendToDevice("", "Notification from Python", "Text of the nootification")